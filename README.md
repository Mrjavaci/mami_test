...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mami-test)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mami-test
```

A live public deployment of this template is available at [https://mami-test.templates.workers.dev](https://mami-test.templates.workers.dev)
